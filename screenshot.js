...
export async function takeScreenshot(options) {
    const { url, width = DEFAULT_WIDTH, height = DEFAULT_HEIGHT, waitForSelector, waitForFunction, waitForTimeout = 0, quality = DEFAULT_QUALITY, fullPage = false, timezone, } = options;
    let browser = null;
    try {
